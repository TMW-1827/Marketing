/**
 * Модель товару внутрішнього порталу.
 *
 * Джерела даних: паспорти товару, логістичні картки бренду та чинний прайс
 * для дистриб'юторів.
 *
 * На відміну від зовнішнього порталу, тут є комерційна частина: працівник
 * має бачити ціну, зону й рекомендовану роздрібну — без цього неможливо ні
 * порахувати націнку точки, ні перевірити накладну на складі.
 *
...
/**
 * Дві цінові зони прайсу. Різниця — логістичне плече: захід і Київ
 * обслуговуються з заводів напряму, решта країни — через плече.
 */
